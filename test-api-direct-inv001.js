...
async function testAPI() {
  try {
    console.log('测试 API: /api/purchase-orders/69952a28916340abda45c932\n');
    
    const response = await fetch('http://localhost:8080/api/purchase-orders/69952a28916340abda45c932');
